...
public class ForceField : MonoBehaviour
{
    ...
    private float lastShrinkEmdTime;
    ...
    void Update()
    {
        ...
        {
            if (Time.time - lastShrinkEmdTime >= shrinkWaitTime && transform.localScale.x > minShrinkAmount)
                Shrink();
        }
    ...
    void Shrink()
    {
        ...
        lastShrinkEmdTime = Time.time + shrinkDuration;
    }
